@extends('admin::layouts.auth', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Material Dashboard')])
    ...
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="{{ route('admin.login') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body">
            <p class="card-description text-center">{{ __('Or Sign in with ') }} <strong>admin@admin.com</strong> {{ __(' and the password ') }}<strong>secret</strong> </p>
